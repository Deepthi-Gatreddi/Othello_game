...
public class OthelloBoard {
	...
	private int NoOfOnes; //to find final winner
	...
	public boolean move(int symbol, int x, int y){
       ...
       //check for valid move, if x and y coordinates are within the 8*8 range
	   if(x<0 || y<0 || x>=8 || y>=8 || board[x][y]!=0 ){
            return false;
        }
        
        int[] XDir = {0, 1, 1, 1, 0, -1, -1, -1}; //an array of 8 xdirection
		int[] YDir = {1, 1, 0, -1, -1, -1, 0, 1}; //an array of 8 yDirections
        int c = 0;
